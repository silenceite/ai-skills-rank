...
def gen_html(repos, month):
    ...
    return f"""<!DOCTYPE html><html lang="zh-CN"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><meta name="description" content="国产 AI Agent Skill 创作榜单 Top 20。发现中国开发者和团队创作的 Agent Skill，基于综合热度、技术创新度、国内影响力排名。每月 5 号更新。"><meta property="og:title" content="国产 AI Agent Skills 创作榜单 Top 20 — {month}"><meta property="og:description" content="中国开发者做了什么？发现国产 AI Agent Skill，看国内创新力量。每月自动更新。"><meta name="twitter:card" content="summary_large_image"><link rel="icon" type="image/svg+xml" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><rect width='32' height='32' rx='6' fill='%23534AB7'/><text x='16' y='23' text-anchor='middle' font-size='16' font-weight='bold' fill='white' font-family='system-ui'>AS</text></svg>">
