...
def gen_html(repos, month):
    ...
    return f"""<!DOCTYPE html><html lang="zh-CN"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><meta name="description" content="中文友好 AI Agent Skill 榜单 Top 30。评估中文文档完整度、国内社区讨论度、中文维护者等 5 个维度。帮中文用户找到最适合的 Skill。每月 4 号更新。"><meta property="og:title" content="中文友好 AI Agent Skills 榜单 Top 30 — {month}"><meta property="og:description" content="中文用户看得懂吗？评估中文文档、社区讨论度、国产生态适配。每月自动更新。"><meta name="twitter:card" content="summary_large_image"><link rel="icon" type="image/svg+xml" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><rect width='32' height='32' rx='6' fill='%23534AB7'/><text x='16' y='23' text-anchor='middle' font-size='16' font-weight='bold' fill='white' font-family='system-ui'>AS</text></svg>">
